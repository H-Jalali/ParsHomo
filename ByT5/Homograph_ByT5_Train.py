...
#     "json",
#     data_files="Homograph\Paper\Data\Sample_15_Homo_Dataset_Train_eSpeak.jsonl",
#     split="train",
# )
...
# Loading ByT5 Model and Tokenizer
model_name = "google/byt5-small"    # or "byt5-base"
...
training_args = Seq2SeqTrainingArguments(
    output_dir="Homograph\Models\Homograph_Paper_ByT5_Instruction_14040430_log",
    eval_strategy="epoch",
    save_strategy="epoch",
...
# Fine-tunimg the Model
trainer.train()

# Saving the Model
model.save_pretrained("Homograph\Models\Homograph_Paper_ByT5_Instruction_14040430")
tokenizer.save_pretrained("Homograph\Models\Homograph_Paper_ByT5_Instruction_14040430")
